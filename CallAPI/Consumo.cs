...
namespace CallAPI
{
    public class Consumo
    {
        ...
        {
            var uriget = new Uri("http://localhost:3849/api/Registrado");
            ...
            else 
            {
                ...
                {
                    Console.WriteLine("get Exitoso: " + ListRegistrados.Count.ToString());
                }
        ...
        {
            var uri = new Uri("http://localhost:3849/api/token/authenticate");
